    ...
    <section className="min-h-screen bg-gradient-to-b from-white via-rose-50 to-rose-100 py-16 px-4">
      <div className="w-11/12 mx-auto text-center">
        ...
        <p className="text-lg max-w-3xl mx-auto text-gray-700  mb-12">
          ...
          trusted platform connecting hearts and helping individuals find their
          perfect life partners. Whether you're searching for love,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2">Matchmaking with Purpose</h3>
            <p>
          ...
          >
            ...
            <p>
              Your data and contact information are secured and visible only to
              premium or approved users.
            </p>
          </motion.div>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-700 ">
            MatrimonyMatch was created to bring together like-minded individuals
            who value culture, integrity, and commitment. We aim to make
            matrimonial matchmaking respectful, modern, and emotionally
            fulfilling — with the help of secure technology and a user-first
            experience.
          </p>
        </div>
      </div>
